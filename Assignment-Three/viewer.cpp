...
//	vTex1 = glGetAttribLocation(program, "vTex1");
//	glVertexAttribPointer(vTex1, 2, GL_FLOAT, GL_FALSE, 0, (void*)(2*(nv + nn)*sizeof(GLfloat)));
//	glEnableVertexAttribArray(vTex1);

	/*
	 *  Call loadCube to load a cube texture that will
	 *  be used as our environment map.
	 */
	texture = loadCube("VancouverConventionCentreBlur");
